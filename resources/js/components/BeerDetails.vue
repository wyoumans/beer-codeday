<template>
    <div ng-cloak>
        <div class="md:w-2/3 w-full mx-auto" v-if="beerNotFound">
            Beer not found
        </div>
        <div v-else>
            <div
            ...
            <p
                class="uppercase text-sm font-bold pt-6 pb-6 md:w-2/3 w-full mx-auto"
            >
                Details
            </p>
            ...
            <p
                class="uppercase text-sm font-bold pt-6 pb-3 md:w-2/3 w-full mx-auto"
            >
                Pairings
            </p>
            ...
            <div class="md:w-2/3 w-full mx-auto" v-if="recipes.length == 0">
                No pairings found
            </div>
        </div>
    </div>
        ...
        getBeer() {
            ...
            axios
                ...
                .then(({ data }) => {
                    ...
                    this.beerNotFound = false;
                    this.$Progress.finish();
                })
                .catch(error => {
                    this.$Progress.fail();
                    this.beerNotFound = true;
                });
        }
    }
};
